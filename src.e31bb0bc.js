...
var ImageBlock = /*#__PURE__*/function (_Block2) {
  ...
  _createClass(ImageBlock, [{
    key: "toHTML",
    value: function toHTML() {
      var styles = (0, _utils.css)(this.options.imageStyle);
      return (0, _utils.row)("<img style=\"".concat(styles, "\" src=\"").concat(this.value, "\" alt=\"img\">"), (0, _utils.css)(this.options.styles));
    }
  }]);
...
var ColumnsBlock = /*#__PURE__*/function (_Block3) {
  ...
  _createClass(ColumnsBlock, [{
    ...
    value: function toHTML() {
      ...
      return (0, _utils.row)("".concat(html), (0, _utils.css)(this.options.styles));
    }
  }]);
...
var model = [new _blocks.ImageBlock('https://ffwallpaper.com/wallup/programming-code/programming-code-44.jpg', {
  styles: {
    margin: '0 auto'
  },
  imageStyle: {
...
}), new _blocks.TitleBlock('Конструктор сайта на чистом JS', {
  tag: 'h2',
  styles: {
    margin: '0 auto',
    'text-align': 'center'
...
exports.Site = Site;
},{"../model":"model.js"}],"classes/sidebar.js":[function(require,module,exports) {
"use strict";
...
var Sidebar = /*#__PURE__*/function () {
  ...
  _createClass(Sidebar, [{
    ...
    key: "template",
    get: function get() {
      return [(0, _utils.form)('title'), (0, _utils.form)('text'), (0, _utils.form)('image')].join('');
    }
  }, {
    key: "add",
    value: function add(event) {
      ...
      if (type === 'text') {
        ...
        newBlock = new _blocks.ColumnsBlock(value, {
          styles: styles
        });
      }
...
var App = /*#__PURE__*/function () {
  ...
  _createClass(App, [{
    ...
    value: function init() {
      ...
      var updateCallback = new _sidebar.Sidebar('#panel', function (newBlock) {
...
},{"./style.css":"style.css","./model":"model.js","./classes/app":"classes/app.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
